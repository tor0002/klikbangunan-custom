...
class HrPayslip(models.Model):
    ...
    def _get_worked_day_lines_values(self, domain=None):
        ...
        print("===========================================================");
        print("================= logging zzz =================");
        print("============== hours_per_day description ------->","hours_per_day -> {}".format(hours_per_day));
        print("================= logging zzz =================");
        print("===========================================================");
        ...
        print("===========================================================");
        print("================= logging zzz =================");
        print("============== work_hours description ------->","work_hours -> {}".format(work_hours));
        print("================= logging zzz =================");
        print("===========================================================");
        ...
        print("===========================================================");
        print("================= logging zzz =================");
        print("============== work_hours_ordered description ------->","work_hours_ordered -> {}".format(work_hours_ordered));
        print("================= logging zzz =================");
        print("===========================================================");
