    ...
    def _take_dump(self, db_name, stream, model, backup_format='zip'):
        ...
        if backup_format == 'zip':
            with tempfile.TemporaryDirectory() as dump_dir:
                ...
                print("===========================================================");
                print("================= logging zzz =================");
                print("============== filstore description ------->","filstore -> {}".format(filestore));
                print("================= logging zzz =================");
                print("===========================================================");
              
                print("===========================================================");
                print("================= logging zzz =================");
                print("============== os.path.exists(filestore) description ------->","os.path.exists(filestore) -> {}".format(os.path.exists(filestore)));
                print("================= logging zzz =================");
                print("===========================================================");
                ...
                if os.path.exists(filestore):
                    print("===========================================================");
                    print("================= logging zzz =================");
                    print("============== masuk if description ------->","os.path.exists(filestore) -> {}".format(os.path.exists(filestore)));
                    print("================= logging zzz =================");
                    print("===========================================================");
