...
class StockMove(models.Model):
    ...
    total_all_weight = fields.Float('Total All Weight', compute='_compute_total_all_weight')
...
class StockPicking(models.Model):
    ...
    @api.depends('move_ids_without_package.total_weight')
    def _compute_total_all_weight(self):
        for picking in self:
            picking.total_all_weight = sum(move.total_weight for move in picking.move_ids_without_package)
